...
//1) Создать 5 разных Tuples с разными типами данных.Один из них должен содержать все месяца года на русском.Второй на английском
...
let monthTupleRu = (month1: "Январь",
                    month2: "Февраль",
                    month3: "Март",
                    month4: "Апрель",
                    month5: "Май",
...
let monthTupleEn = (month1: "January",
                    month2: "February",
                    month3: "March",
                    month4: "April",
                    month5: "May",
...
let addressTuple = (country: "Russia",
                    city: "Moscow",
                    street: "Skladochnaya",
                    housenum: 4,
                    floor: 14,
...
//6) Распечатайте наших бедокуров в консоль через print().
...
//7) Выведите каждый параметр в консоль. Тремя способами.
...
//8) Создайте второй кортеж — нашего напарника. Значения задайте другие.
...
//9) Пусть напарники соревнуются: создайте третий кортеж, который содержит в себе разницу между первым и вторым.
...
//10) Вывести в консоль тремя способами.
